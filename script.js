...
function updateButtonText(English) {
    ...
    button.innerHTML = `<i class="bi bi-translate me-1"></i>${English}`; //template literal that dynamically inserts the value of the English parameter into the button's content
  }
